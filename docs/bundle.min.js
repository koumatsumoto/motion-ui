!(function(e) {
  ...
  function(e, t, n) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }), r(n(7)), r(n(9));
  },
  function(e, t, n) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.inputCount = 10),
      (t.longHoldCount = t.inputCount),
      (t.shortHoldCount = 7),
      (t.stoppingCount = 3),
      (t.startingIndex = t.inputCount - t.stoppingCount),
      (t.firstMoveIndex = t.inputCount - t.stoppingCount),
      (t.secondMoveIndex = t.inputCount - 2),
      (t.thirdMoveIndex = t.inputCount - 1);
  },
  function(e, t, n) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 }),
  ...
  function(e, t, n) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 }), n(4).debug();
  },
  function(e, t, n) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 });
    ...
    t.debug = () =>
      r.runOnDocumentReady(() => {
        ...
        let a, c, u;
        o.getLastCommandStream().subscribe((e) => (a = e)),
          o.getCommandHistoryStream().subscribe((e) => (c = e)),
          o.debug3().subscribe((e) => (u = e));
        const s = () => {
          a && i(JSON.stringify(a, null, 2), 'left-top'),
            c && i(JSON.stringify(c, null, 2), 'left-bot'),
            u && i(JSON.stringify(u, null, 2), 'right-top'),
  ...
  function(e, t, n) {
    ...
    const r = n(0),
      ...
      i = n(2);
    (t.debug3 = () => {
      const { filter: e, map: t } = r.getRx().operators;
      return i.getMotionUnitStream().pipe(
        e((e) => e.data.rate > 0),
        t(
          (e) =>
            `${'up' === e.data.direction ? 'u' : 'd'}-${e.data.rate}: ${e.sid}`,
        ),
        r.withHistory(32),
        t((e) => e.reverse()),
      );
      ...
      (t.getCommandHistoryStream = () => {
        const { map: e } = r.getRx().operators;
        return o.getMovementStream().pipe(
          r.withHistory(32),
          e((e) => e.map((e) => e.type).reverse()),
        );
      }),
      (t.getLastCommandStream = () => {
        const { distinctUntilChanged: e, map: t } = r.getRx().operators;
        return o.getMovementStream().pipe(
          t((e) => e.type),
          e(),
          r.withHistory(32),
      ...
      (t.getCommandStream = () => {
        const { Observable: e } = r.getRx(),
          { map: t } = r.getRx().operators;
        return new e((e) => {
          o.getMovementStream().pipe(
            r.withHistory(6),
            t((e) => {}),
          );
        });
  ...
  function(e, t, n) {
    ...
    t.getMovementStream = () => {
      const { Observable: e } = r.getRx(),
        { map: t } = r.getRx().operators;
      return new e((e) => {
        o.getMotionUnitStream()
          .pipe(
            r.withHistory(i.inputCount),
            t((e) => {
              const t = e.map((e) => e.data),
                n = [e[0].sid, e[e.length - 1].sid];
              return { type: a.detectMovement(t), sid: n };
            }),
          )
          .subscribe((t) => {
            e.next(t);
  ...
  function(e, t, n) {
    ...
    const r = n(14),
      ...
      a = n(23),
      c = n(28);
    t.getMotionUnitStream = (
      e = r.getDeviceOrientationStream(),
      t = o.getDeviceMotionStream(),
    ) => {
      const { bufferCount: n, map: u, withLatestFrom: s } = i.getRx().operators;
      let l = 0;
      return t.pipe(
        n(4),
        s(e),
  ...
  function(e, t, n) {
    ...
    const r = (e, t) =>
      e > t.veryHigh
        ...
        ? 1
        : 0;
    t.unify = (e, n = t.defaultThreshold) => {
      if (e.first < e.last) {
  ...
  function(e, t, n) {
    ...
    const r = n(30),
      ...
      i = n(32);
    t.detectMovement = (e) =>
      r.isStoppingMovementInput(e)
        ? o.detectStopAndStartMovement(e)
        : i.detectMovingMovement(e);
  },
  function(e, t, n) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.isStoppingMovementInput = (e) =>
        10 === e.length &&
        0 === e[e.length - 1].rate &&
        0 === e[e.length - 2].rate);
  },
  function(e, t, n) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 });
    const r = n(1);
    t.detectStopAndStartMovement = (e) => {
      if (0 !== e[r.startingIndex].rate)
        return e[r.startingIndex].rate > 1 ? 'quick start' : 'slow start';
      let t = 0;
      for (let n = e.length - 1; 0 <= n && 0 === e[n].rate; n--) t++;
      return t >= r.longHoldCount
        ? 'long hold'
        : t >= r.shortHoldCount
        ? 'short hold'
        : 'stopping';
  ...
  function(e, t, n) {
    ...
    const r = n(1),
      o = n(33);
    t.detectMovingMovement = (e) => {
      const t = o.simplifyMovements([
          e[r.firstMoveIndex],
          e[r.secondMoveIndex],
          e[r.thirdMoveIndex],
        ]),
        ...
        i = t[1],
        a = t[2];
      return (0 === n.rate || 1 === n.rate) &&
        3 <= Math.abs(i.rate) &&
        3 <= Math.abs(a.rate - i.rate)
        ? 0 === a.rate
          ? 'just return'
          : 'over return'
        : 'moving';
